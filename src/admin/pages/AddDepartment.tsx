          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-3 mt-4 sm:mt-0">
              <div className="glass-card px-4 py-2 flex items-center">
                ...
                <span className="text-sm text-gray-600">{departments.length} Departments</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="glass-card p-6 lg:p-8 h-full">
              <div className="flex items-center mb-8 pb-6 border-b border-white/20">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm mt-1">Create new departments</p>
                </div>
              </div>
                  ...
                  <div className="glass-card p-2 w-full">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-800">{departments.length}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="glass-card p-6 lg:p-8 h-full">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-white/20">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  >
                    <svg className={`w-4 h-4 mr-2 ${fetching ? 'animate-spin' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {fetching ? (
                ...
                <div className="space-y-4 max-h-[500px] overflow-y-auto pr-2">
                  {departments.map((department) => (
                    <div key={department.departmentId} className="glass-card border border-white/30 hover:border-white/50 transition-all duration-300 hover:shadow-lg">
                      <div className="p-5">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                          <div className="flex-1">
                            <div className="flex items-center space-x-4">
                              <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-sm flex-shrink-0">
                                <span className="text-green-900 font-bold text-lg">{department.departmentId}</span>
                              </div>
                              <div className="flex-1 min-w-0">
                                <h3 className="text-lg font-bold text-gray-800 truncate">{department.name}</h3>
                                <p className="text-gray-600 text-sm mt-1 truncate">{department.description}</p>
                              </div>
                            </div>
                          </div>
                          <div className="flex-shrink-0">
