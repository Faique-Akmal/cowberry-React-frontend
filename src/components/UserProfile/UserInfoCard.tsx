      ...
      <Modal isOpen={isOpen} onClose={handleModalClose} className="max-w-[700px] m-4">
        <div className="relative w-full p-4 bg-white rounded-3xl dark:bg-gray-900 lg:p-11">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            {t("profile.Update your address below.")}
          </p>
          ...
          <form onSubmit={handleSave} className="flex flex-col">
            <Label htmlFor="address">{t("profile.first_name")}</Label>
            <Input
              id="first_name"
              type="text"
              value={first_name}
            ...
            />
             <Label htmlFor="address"> {t("profile.Last Name")}</Label>
            <Input
              id="last_name"
              type="text"
              value={last_name}
            ...
            />
             <Label htmlFor="address"> {t("profile.mobile_no")}</Label>
            <Input
              id="tel"
              type="tel"
              value={mobile_no}
            ...
            <div className="flex items-center gap-3 mt-6 justify-end">
              ...
              <Button 
                ...
                disabled={isLoading}
              >
                {isLoading ? t("button.Saving...") : t("button.Save Changes")}
              </Button>
            </div>
          </form>
        </div>
