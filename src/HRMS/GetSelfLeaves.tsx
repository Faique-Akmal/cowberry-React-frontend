...
// Define types based on Frappe API response
...
// Types for leave requests (you'll need to adjust based on your actual leave request API)
...
const LeaveStatus: React.FC<LeaveStatusProps> = ({ token }) => {
  ...
  // Fetch leave balances from Frappe
  ...
  // Fetch leave requests (you'll need to implement this based on your actual API)
  ...
  useEffect(() => {
    fetchAllData();
  }, [currentPage, filterLeaveType, filterStatus]);
