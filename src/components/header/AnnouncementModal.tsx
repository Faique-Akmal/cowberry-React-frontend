          ...
          <div className="relative flex items-center justify-between p-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm">
            <div>
              ...
              <div className="flex items-center gap-2 mt-2">
                <span
                  className={`text-xs font-medium px-3 py-1 rounded-full ${getPriorityColor(announcement.priority)} backdrop-blur-sm border border-white/30 dark:border-gray-700/30`}
                >
